 ...
 */  
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getLastNetworkId(uint16_t *network_id, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getLastDataLength(uint8_t *data_length, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int setNetworkId(uint16_t network_id, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getUWBSettings(UWB_settings_t *UWB_settings, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int setUWBSettings(UWB_settings_t *UWB_settings, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_FAIL function failed.
    */
    static int setUWBChannel(int channel_num, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getUWBChannel(int* channel_num, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int setTxPower(float txgain_dB, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getTxPower(float* txgain_dB, uint16_t remote_id = (uint16_t)NULL);
 ...
 */
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getWhoAmI(uint8_t *whoami, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getFirmwareVersion(uint8_t *firmware, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getHardwareVersion(uint8_t *hardware, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getSelftest(uint8_t *selftest, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getErrorCode(uint8_t *error_code, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @see waitForFlag
    */
    static int getInterruptStatus(uint8_t *interrupts, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getCalibrationStatus(uint8_t *calibration_status, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int getGPIO(int gpio_num, uint8_t *value, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int setGPIO(int gpio_num, uint8_t value, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static void resetSystem(uint16_t remote_id = (uint16_t)NULL);
    ...
    * @see setLedConfig
    */
    static int setLed(int led_num, boolean state, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getInterruptMask(uint8_t *mask, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int setInterruptMask(uint8_t mask, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getConfigModeGPIO(int gpio_num, uint8_t *mode, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getConfigPullGPIO(int gpio_num, uint8_t *pull, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int setConfigGPIO(int gpio_num, int mode, int pull, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @see setLed
    */
    static int setLedConfig(uint8_t config = 0x0, uint16_t remote_id = (uint16_t)NULL);
     ...
     * @retval #POZYX_FAIL function failed.   
     */
    static int configInterruptPin(int pin, int mode, int bActiveHigh, int bLatch, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int saveConfiguration(int type, uint8_t registers[] = NULL, int num_registers = 0, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int clearConfiguration(uint16_t remote_id = (uint16_t)NULL);
     ...
     */
    static bool isRegisterSaved(uint8_t regAddress, uint16_t remote_id = (uint16_t)NULL);
     ...
     * @return           the number of register variables saved in flash memory.
     */
    static int getNumRegistersSaved(uint16_t remote_id = (uint16_t)NULL);
 ...
 */
    ...
    */
    static int getCoordinates(coordinates_t *coordinates, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @see getCoordinates
    */
    static int setCoordinates(coordinates_t coordinates, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getPositionError(pos_error_t *pos_error, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int setPositioningAnchorIds(uint16_t anchors[], int anchor_num, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int getPositioningAnchorIds(uint16_t anchors[], int anchor_num, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int getUpdateInterval(uint16_t *ms, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int setUpdateInterval(uint16_t ms, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int getPositionAlgorithm(uint8_t *algorithm, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int getPositionDimension(uint8_t *dimension, uint16_t remote_id = (uint16_t)NULL);
    ...
    */
    static int setPositionAlgorithm(int algorithm = POZYX_POS_ALG_UWB_ONLY, int dimension = 0x0, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getAnchorSelectionMode(uint8_t *mode, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */  
    static int getNumberOfAnchors(uint8_t *nr_anchors, uint16_t remote_id = (uint16_t)NULL);
    ...
    */  
    static int setSelectionOfAnchors(int mode, int nr_anchors, uint16_t remote_id = (uint16_t)NULL);
    ...
    */  
    static int getOperationMode(uint8_t *mode, uint16_t remote_id = (uint16_t)NULL);
    ...
    */    
    static int setOperationMode(uint8_t mode, uint16_t remote_id = (uint16_t)NULL);
    ...
    *
    */
    static String getSystemError(uint16_t remote_id = (uint16_t)NULL);
 ...
 */
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getSensorMode(uint8_t *sensor_mode, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_FAIL function failed.
    */
    static int setSensorMode(uint8_t sensor_mode, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getAllSensorData(sensor_data_t *sensor_data, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getPressure_Pa(float32_t *pressure, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getAcceleration_mg(acceleration_t *acceleration, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getMagnetic_uT(magnetic_t *magnetic, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getAngularVelocity_dps(angular_vel_t *angular_vel, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getEulerAngles_deg(euler_angles_t *euler_angles, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getQuaternion(quaternion_t *quaternion, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getLinearAcceleration_mg(linear_acceleration_t *linear_acceleration, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getGravityVector_mg(gravity_vector_t *gravity_vector, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_TIMEOUT function timed out, no response received.
    */
    static int getTemperature_c(float32_t *temperature, uint16_t remote_id = (uint16_t)NULL);
 ...
 */
    ...
    */
    static int getDeviceRangeInfo(uint16_t device_id, device_range_t *device_range, uint16_t remote_id = (uint16_t)NULL);
 ...
 */    
    ...
    */
    static int getDeviceListSize(uint8_t *device_list_size, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_FAIL function failed.
    */
    static int getDeviceIds(uint16_t devices[], int size, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_FAIL function failed.
    */
    static int getAnchorIds(uint16_t anchors[], int size, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_FAIL function failed.
    */
    static int getTagIds(uint16_t tags[], int size, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_FAIL function failed.
    */
    static int clearDevices(uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_FAIL function failed.
    */
    static int addDevice(device_coordinates_t device_coordinates, uint16_t remote_id = (uint16_t)NULL);
    ...
    * @retval #POZYX_FAIL function failed.
    */
    static int getDeviceCoordinates(uint16_t device_id, coordinates_t *coordinates, uint16_t remote_id = (uint16_t)NULL);
